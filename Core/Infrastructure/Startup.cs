...
namespace Core.Infrastructure
{
    public static class Startup
    {
        public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration config)
        {
            ...
            services.AddScoped<IClinicsDetailsRepository, ClinicsDetailsRepository>();
            services.AddScoped<IClinicsDetailsService, ClinicsDetailsService>();
            services.AddScoped<IFollowUpAppointmentRepository, FollowUpAppointmentRepository>();
            services.AddScoped<IFollowUpAppointmentService, FollowUpAppointmentService>();
            services.AddScoped<IPrescriptionRepository, PrescriptionRepository>();
            services.AddScoped<IPrescriptionService, PrescriptionService>();
            services.AddScoped<IDentalRecordRepository, DentalRecordRepository>();
            services.AddScoped<IDentalRecordService, DentalRecordService>();
            services.AddScoped<IMedicalRecordRepository, MedicalRecordRepository>();
            services.AddScoped<DentistDAO>();
            services.AddScoped<ClinicsDAO>();
            services.AddScoped<ClinicsDetailsDAO>();
            services.AddScoped<PrescriptionDAO>();
            services.AddScoped<DentalRecordDAO>();
            services.AddScoped<FollowUpAppointmentDAO>();
